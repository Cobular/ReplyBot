...
"""A Cog that controls the search and reply functionality of the bot. Does not do message saving yet.
...
class ReplyCog(commands.Cog, name="Reply Commands"):
    ...
    async def reply(self, ctx, channel: typing.Optional[discord.TextChannel], target_user: typing.Optional[discord.Member],
                    *, user_input):
    ...
    async def send_original_message(self, ctx, message_content, message_sender, message_sent_time):
        ...
        embed.set_author(name=sender.nick, icon_url=sender.avatar_url)
